...
export enum HttpRedirectCode {
	 ...
	 * temporary  (the original describing phrase was "Moved
	 ...
	 * issue a  with a separate `GET` message.
	 */
	SeeOther = 303,
	 ...
	 * permanently ed resource may continue smoothly.
	 */
	Permanent = 308,
}
...
export const HttpStatusCode = {
	...HttpInfoCode, // 100 - 199
	...HttpSuccessCode, // 200 - 299
	...HttpRedirectCode, // 300 - 399
	...HttpClientErrorCode, // 400 - 499
	...HttpServerErrorCode, // 500 - 599
};
